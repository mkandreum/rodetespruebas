...
export function initDOMRefs() {
    ...
    // Initialize navigation links collections
    document.querySelectorAll('#main-nav [data-nav]').forEach(el => {
        domRefs.mainNavLinks[el.dataset.nav] = el;
    });

    document.querySelectorAll('#secondary-nav [data-nav]').forEach(el => {
        domRefs.secondaryNavLinks[el.dataset.nav] = el;
    });

    document.querySelectorAll('#mobile-menu [data-nav]').forEach(el => {
        domRefs.mobileNavLinks[el.dataset.nav] = el;
    });
